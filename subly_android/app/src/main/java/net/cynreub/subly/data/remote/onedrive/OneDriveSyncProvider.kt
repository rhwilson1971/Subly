...
/**
 * Stores all data as three JSON files in the user's OneDrive appRoot:
 * subscriptions.json, payment_methods.json, categories.json.
 * Each mutating operation does a read-modify-write on the relevant file.
 */
@Singleton
class OneDriveSyncProvider @Inject constructor(
    private val driveClient: OneDriveClient
) : SyncProvider {
